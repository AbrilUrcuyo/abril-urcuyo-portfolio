# abril-urcuyo-portfolio
I am Abril Urcuyo Arce, a Software Engineering student at the Universidad Nacional of Costa Rica,
with an interest in systems programming and networking.

This repository serves as a portfolio showcasing my most relevant academic
and personal projects.

## 🛠 Technical Skills

- **Programming Languages:** C, C++, Python, JavaScript
- **Backend & Databases:** MySQL, SQLite, REST APIs, JWT authentication
- **Systems & Networking:** Linux, TCP/IP, sockets, Cisco Networking
- **DevOps & Tools:** GitHub, Docker (basic), Azure (basic)
- **Methodologies:** Agile / Scrum

## 🚀 Projects

### 🏥 Medical Appointments Management System
Fullstack web application for managing medical appointments.

- Secure authentication and authorization using JWT
- Role-based access (patients, doctors, administrators)
- REST API developed with Spring Boot
- Frontend SPA developed with React
...
👉 https://github.com/AbrilUrcuyo/Message_Broker
...
Fourth-year student — Expected graduation: November 2026

**Diploma in Application Programming**  
Universidad Nacional of Costa Rica

**Technical Diploma in Computer Networking**  
...
- Backend and infrastructure-oriented software development
